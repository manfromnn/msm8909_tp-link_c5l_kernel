...
{FT5X36_VENDOR0x69_HXD,"HXD"},
{FT5X36_VENDOR_CHAOSHENG,"ChaoSheng"},
{FT5X36_VENDOR_TOPTOUCH,"Toptouch"},
{FT6X36_VENDOR0x9b_JINLONG,"HXD"}, //modify vendor ID error by  shj  for QL610 20150710
{FT6X36_FIRMWARE0x67_DIJING,"DIJING"},//add by shihuijun for hardinfo DIJING 20150824
