	...
	uint32_t first_start, uint32_t blocking)
{
	...
	if (blocking) {
		...
		rc = wait_for_completion_timeout(
			/*modify by wangyi for SW00179533  50->300 qcomm case 02258422 20151207 begin*/
			&vfe_dev->reset_complete, msecs_to_jiffies(300));
		      /*modify by wangyi for SW00179533  50->300 qcomm case 02258422 20151207 end*/
	} else {
		msm_camera_io_w_mb(0x3FF, vfe_dev->vfe_base + 0x4);
	}
	return rc;
